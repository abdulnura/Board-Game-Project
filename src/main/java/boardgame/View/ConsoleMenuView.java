...
public class ConsoleMenuView {
    ...
    /**
     * Allows and ask players to enter the board size (5)
     * @return the board if the entered size is 5 or throws InvalidBoardSizeException if its greater or less than the 5
     */
    protected static int enterSize() {
        ...
        try {
            ...
            System.out.println("Input is wrong, please enter correct integer 5");
            enterSize();
        }
        return BOARD_SIZE;
    }
